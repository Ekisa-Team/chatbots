/*
  ...
  - Added the required column `http_verb` to the `channel` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_channel" ("account_sid", "auth_token", "callback_url", "cellphone", "chatbot_id", "created_at", "id", "messaging_provider_id", "updated_at") SELECT "account_sid", "auth_token", "callback_url", "cellphone", "chatbot_id", "created_at", "id", "messaging_provider_id", "updated_at" FROM "channel";
DROP TABLE "channel";
